export default function Footer() {
  return (
    <footer className="bg-white border-t border-gray-200 py-6 sm:py-5 px-4 sm:px-6">
      <div className="mx-auto">
        {/* Gallery section */}
        <div className="mb-6 sm:mb-8">
          <h3 className="text-base sm:text-3xl font-semibold text-gray-900 mb-3 sm:mb-4">Gallery</h3>
