export default function Footer() {
  return (
    <footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 py-6 sm:py-5 px-4 sm:px-6 transition-colors">
      <div className="mx-auto">
        {/* Gallery section */}
        <div className="mb-6 sm:mb-8">
          <h3 className="text-base sm:text-3xl font-semibold text-gray-900 dark:text-white mb-3 sm:mb-4">Gallery</h3>
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-2 sm:gap-4">
            {/* Placeholder gallery items */}
            {Array.from({ length: 12 }).map((_, index) => (
              <div
                key={index}
                className="aspect-square bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-600 rounded-lg hover:opacity-80 transition-opacity cursor-pointer"
              >
        ...
        <div className="flex fixed gap-2 bottom-5 right-10">
          <button className="flex items-center cursor-pointer bg-gray-200 shadow-md shadow-gray-400 transition-all rounded-lg p-1 text-gray-600 hover:text-gray-900 text-xs sm:text-sm font-medium">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center pt-4 sm:pt-6 border-t border-gray-200">
          ...
          <div className="flex items-center space-x-2 mb-3 sm:mb-0">
            ...
            <span className="text-gray-900 dark:text-white font-semibold text-sm sm:text-base">Krea AI</span>
          </div>

          {/* Right side - Links */}
          <div className="flex items-center space-x-4 sm:space-x-6 mr-auto sm:mr-45">
            <div className="flex items-center space-x-1 sm:space-x-2 text-gray-500 dark:text-gray-400 text-xs sm:text-sm">
