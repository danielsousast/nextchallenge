...
export default function Header() {
  ...
  return (
    <header className="bg-white px-4 sm:px-6 py-2">
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          <div className="hidden sm:flex items-center space-x-1">
            <div className="flex items-center justify-center size-8 rounded-full bg-gray-200">
              <svg className="w-5 h-5 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
              </svg>
            </div>
            <span className="text-gray-500 font-medium px-1">benevolentnimblebat</span>
        ...
        <nav className="hidden lg:flex items-center space-x-2 xl:space-x-4 bg-gray-100 p-2 rounded-2xl">
          <button className="py-2 px-3 hover:bg-white hover:shadow-md rounded-xl transition-all group">
            <svg className="w-5 h-5" fill="none" stroke="#4C4D4C" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
            </svg>
          </button>
          <button className="py-2 px-3 hover:bg-white hover:shadow-md rounded-xl transition-all">
            <svg className="w-5 h-5" fill="none" stroke="#4C4D4C" viewBox="0 0 24 24">
          ...
          <button className="py-2 px-3 hover:bg-white hover:shadow-md rounded-xl transition-all">
            <svg className='w-5 h-5' fill="#4C4D4C" viewBox="0 0 24 24">
          ...
          <button className="py-2 px-3 hover:bg-white hover:shadow-md rounded-xl transition-all">
            <svg className="w-5 h-5" fill="#4C4D4C" stroke="#4C4D4C" viewBox="0 0 24 24">
          ...
          <button className="py-2 px-3 hover:bg-white hover:shadow-md rounded-xl transition-all">
            <svg className="w-5 h-5" fill="none" stroke="#4C4D4C" viewBox="0 0 30 30">
        ...
        {/* Right side - Actions */}
        <div className="flex items-center space-x-2 sm:space-x-4">
          <button className="hidden sm:flex items-center text-gray-700 hover:text-gray-900 hover:shadow-md font-medium px-2 transition-all bg-gray-100 p-1 rounded-xl">
          ...
          <button className="p-2 hover:bg-gray-100 hover:shadow-md rounded-lg transition-all">
            <svg className="w-5 h-5 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            className="p-2 hover:bg-gray-100 hover:shadow-md rounded-lg transition-all"
          >
            {isDarkMode ? (
              <svg className="w-5 h-5 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button className="flex items-center justify-center p-2 bg-gray-200 hover:bg-gray-300 hover:shadow-md size-10 rounded-full transition-all">
            <svg className="w-5 h-5 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
            </svg>
          </button>
