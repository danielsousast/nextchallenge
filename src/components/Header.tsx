    ...
    <header className="bg-white px-4 sm:px-6 py-2">
      <div className="flex items-center justify-between w-full">
        ...
        <nav className="hidden lg:flex items-center space-x-2 xl:space-x-4 bg-gray-100 p-2 rounded-2xl">
          ...
          <button className="py-2 px-3 hover:bg-white hover:shadow-md rounded-xl transition-all cursor-pointer">
            <svg className="w-5 h-5" fill="none" stroke="#4C4D4C" viewBox="0 0 24 24">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          <button
            ...
            className="p-2 hover:bg-gray-100 hover:shadow-md rounded-lg transition-all cursor-pointer"
          >
            {isDarkMode ? (
              <svg className="w-5 h-5 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
